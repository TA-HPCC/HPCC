...
plt.plot(np.linspace(0, 10, num=20),DINT_1_95_wb, color='red', linestyle='-', label='DINT obs_window = 1 micro s',linewidth=4.0)
plt.plot(np.linspace(0, 10, num=20),DINT_2_95_wb, color='blue', linestyle='--', label='DINT obs_window = 10 micro s',linewidth=4.0)
plt.plot(np.linspace(0, 10, num=20),DINT_3_95_wb, color='green', linestyle='-.', label='DINT obs_window = 100 micro s',linewidth=4.0)
plt.plot(np.linspace(0, 10, num=20),DINT_4_95_wb, color='purple', linestyle=':', label='DINT obs_window = 1 ms',linewidth=4.0)
