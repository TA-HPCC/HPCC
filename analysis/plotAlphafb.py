...
fb_file = 'fct_fb50_alpha_dint.dat'
...
plt.plot(np.linspace(0, 10, num=20),DINT_1_95_fb, color='red', linestyle='-', label='DINT alpha = 1.5',linewidth=4.0)
plt.plot(np.linspace(0, 10, num=20),DINT_2_95_fb, color='blue', linestyle='--', label='DINT alpha = 1.25',linewidth=4.0)
plt.plot(np.linspace(0, 10, num=20),DINT_3_95_fb, color='green', linestyle='-.', label='DINT alpha = 1.125',linewidth=4.0)
plt.plot(np.linspace(0, 10, num=20),DINT_4_95_fb, color='purple', linestyle=':', label='DINT alpha = 1.0675',linewidth=4.0)
