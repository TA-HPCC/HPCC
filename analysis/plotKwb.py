...
plt.plot(np.linspace(0, 10, num=20),DINT_1_95_wb, color='red', linestyle='-', label='DINT k = 16',linewidth=4.0)
plt.plot(np.linspace(0, 10, num=20),DINT_2_95_wb, color='blue', linestyle='--', label='DINT k = 8',linewidth=4.0)
plt.plot(np.linspace(0, 10, num=20),DINT_3_95_wb, color='green', linestyle='-.', label='DINT k = 4',linewidth=4.0)
plt.plot(np.linspace(0, 10, num=20),DINT_4_95_wb, color='purple', linestyle=':', label='DINT k = 2',linewidth=4.0)
