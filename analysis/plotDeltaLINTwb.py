...
wb_file = 'fct_wb50_all_lint_delta.dat'


LINT_1_50_wb = [float(line.split()[2]) for line in open(wb_file).readlines()[0:]]     # web search
LINT_1_95_wb = [float(line.split()[3]) for line in open(wb_file).readlines()[0:]]     # web search
LINT_1_99_wb = [float(line.split()[4]) for line in open(wb_file).readlines()[0:]]     # web search
LINT_2_50_wb = [float(line.split()[5]) for line in open(wb_file).readlines()[0:]]    # web search
LINT_2_95_wb = [float(line.split()[6]) for line in open(wb_file).readlines()[0:]]    # web search
LINT_2_99_wb = [float(line.split()[7]) for line in open(wb_file).readlines()[0:]]    # web search
LINT_3_50_wb = [float(line.split()[8]) for line in open(wb_file).readlines()[0:]]    # web sear>
LINT_3_95_wb = [float(line.split()[9]) for line in open(wb_file).readlines()[0:]]    # web sear>
LINT_3_99_wb = [float(line.split()[10]) for line in open(wb_file).readlines()[0:]]    # web sear>
LINT_4_50_wb = [float(line.split()[11]) for line in open(wb_file).readlines()[0:]]     # web search
LINT_4_95_wb = [float(line.split()[12]) for line in open(wb_file).readlines()[0:]]     # web search
LINT_4_99_wb = [float(line.split()[13]) for line in open(wb_file).readlines()[0:]]     # web search
LINT_5_50_wb = [float(line.split()[14]) for line in open(wb_file).readlines()[0:]]    # web search
LINT_5_95_wb = [float(line.split()[15]) for line in open(wb_file).readlines()[0:]]    # web search
LINT_5_99_wb = [float(line.split()[16]) for line in open(wb_file).readlines()[0:]]    # web search
LINT_6_50_wb = [float(line.split()[17]) for line in open(wb_file).readlines()[0:]]    # web sear>
LINT_6_95_wb = [float(line.split()[18]) for line in open(wb_file).readlines()[0:]]    # web sear>
LINT_6_99_wb = [float(line.split()[19]) for line in open(wb_file).readlines()[0:]]    # web sear>
